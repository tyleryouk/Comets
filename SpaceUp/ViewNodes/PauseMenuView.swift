...
class PauseMenuView: ModalView {
  ...
  // MARK: - Init
    init() {
        ...
        musicButton.position = CGPoint(x: modalBackground.frame.maxX - 130, y: modalBackground.frame.minY + 150)
        ...
        quitButton.position = CGPoint(x: modalBackground.frame.minX + 130, y: modalBackground.frame.minY + 150)
